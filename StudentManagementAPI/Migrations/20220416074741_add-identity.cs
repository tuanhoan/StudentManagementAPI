        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AvoidLastLesson = table.Column<bool>(type: "bit", nullable: false),
                    RequriedSpacing = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_MapTeacherSubjectTeams", x => new { x.TeamId, x.TeacherId, x.SubjectId });
                    table.ForeignKey(
                        name: "fk_MapTeacherSubjectTeams_Subjects",
                        column: x => x.SubjectId,
                        principalTable: "Subjects",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "fk_MapTeacherSubjectTeams_Teachers",
                        column: x => x.TeacherId,
                        principalTable: "Teachers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "fk_MapTeacherSubjectTeams_Teams",
                        column: x => x.TeamId,
                        principalTable: "Teams",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MapTeacherSubjectTeams_TeacherId",
                table: "MapTeacherSubjectTeams",
                column: "TeacherId");
